...
class Note:
    ...
    def __init__(self, memo, tags=''):
        ...
        tags. Automatically set the note's creation date and unique ID.'''
        self.memo = memo
        self.tags = tags
    ...
    def match(self, filter):
        ...
        True if it matches, False otherwise. Case sensitive.'''
...
class Notebook:
    ...
    def modify_memo(self, note_id, memo):
        '''Find the note with the given id an dchange its memo
        to the given value'''
